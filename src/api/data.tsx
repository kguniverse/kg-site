export const data = {
  ...
  contact: {
    email: "kkwang@outlook.com",
    github: "github.com/kguniverse",
  },
  education: [
    {
      ...
      endDate: "(Scheduled June, 2023)",
    },
  ],
  experience: [
    {
      name: "ACM training team",
      position: "Membership",
      startDate: "May, 2020",
      endDate: "July, 2021",
      description:
  ...
  skills: [
    {
      category: "Languages",
      content: ["C", "Python", "TypeScript", "JavaScript", "Go"],
    },
    {
      category: "Frameworks",
      content: ["React", "FastAPI", "Gin", "Pytorch", "Next.js"],
    },
    {
      category: "Tools",
      content: ["Git", "LaTex", "Docker"],
    },
    {
      category: "Responsive Design",
      content: ["Ant Design", "Material-UI"],
    },
  ],
  honor: [
    {
      name: "the 45th ICPC Asia Regional Contest JiNan Site, Bronze Medal",
      date: "2020.12",
    },
    {
      name: "Chinese High School Mathematics League, second prize",
      date: "2019.9",
    },
  ],
};
